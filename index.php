<?php
// index.php – Redesigned Homepage for R&R Catering
...
<section class="hero" style="background:none; padding:0; height:70vh;">
    ...
    <div class="hero-content">
        ...
        <div class="hero-cta" style="margin-top:25px;">
            ...
            <a href="<?= SITE_URL ?>/client/booking.php" class="btn btn-secondary">
                Book an Event
            </a>
        </div>
    </div>
...
<section class="section" style="background-color: #fefefe; width: 100%;">
    ...
    <div style="text-align:center; margin-top:30px;">
        <a href="<?= SITE_URL ?>/client/register.php" class="btn view-more-button">
